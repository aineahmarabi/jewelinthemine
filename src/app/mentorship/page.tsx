    ...
    return (
      <main className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">Mentorship</h1>
          <p className="text-gray-600">No mentorship posts found.</p>
        </div>
      </main>
    );
  }

  const featuredPost = mentorshipPosts[0];
  const sidebarPosts = mentorshipPosts.slice(1, 4); // Next 3 posts for sidebar
  const gridPosts = mentorshipPosts.slice(4); // Remaining posts for grid
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <p className="text-gray-600 mt-2">Guidance, wisdom, and insights on mentoring and personal development</p>
        </div>
      </div>
        ...
        {gridPosts.length > 0 && (
          <div>
            <div className="border-t border-gray-200 pt-12">
              <h3 className="text-2xl font-bold text-gray-900 mb-8">More Mentorship Articles</h3>
