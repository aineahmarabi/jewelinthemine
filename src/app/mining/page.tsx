    ...
    return (
      <main className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">Mining</h1>
          <p className="text-gray-600">No mining posts found.</p>
        </div>
      </main>
    );
  }

  const featuredPost = miningPosts[0];
  const sidebarPosts = miningPosts.slice(1, 4); // Next 3 posts for sidebar
  const gridPosts = miningPosts.slice(4); // Remaining posts for grid
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <h1 className="text-4xl font-bold text-gray-900">Mining</h1>
          <p className="text-gray-600 mt-2">Latest insights and updates from the mining industry</p>
        </div>
      </div>
        ...
        {gridPosts.length > 0 && (
          <div>
            <div className="border-t border-gray-200 pt-12">
              <h3 className="text-2xl font-bold text-gray-900 mb-8">More Mining Articles</h3>
