...
export default async function ReflectionsCategoryPage() {
  ...
  const reflectionsPosts = allPosts.filter((post) => {
    const categoryName = typeof post.category === 'string' 
      ? post.category 
      : post.category?.title || post.categoryTitle || '';
    return categoryName.toLowerCase() === 'reflections';
  });
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <p className="text-gray-600 mt-2">Personal thoughts, insights, and contemplations on my journey of life</p>
        </div>
      </div>
